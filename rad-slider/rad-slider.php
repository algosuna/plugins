...
/**
  * Front-End display
  * Call this function in your theme, wherever you want the slider to appear
  * Since ver 1.0
  **/
function rad_slider(){
	//set up custom query
...
function rad_slider_scripts(){
	...
	wp_register_script('cycle_custom',$custom_path);
	wp_enqueue_script('cycle_custom');
	//tell WP about the stylesheet
	$style_path=plugins_url('css/style.css',__FILE__);
	wp_register_style('cycle_style',$style_path);
	wp_enqueue_style('cycle_style');
}
